...
namespace MVVMMini
{
  public class ViewModel : INotifyPropertyChanged
  {
    ...
    public ViewModel()
    {
      PlusCommand = new(Plus) { DisplayText = "+", ToolTipText = "Addition" };
      MinusCommand = new(Minus) { DisplayText = "-", ToolTipText = "Subtraktion" };
    ...
    private void Plus()
    {
      // hier würde auf das Model zugegriffen werden
